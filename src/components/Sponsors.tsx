...
const Sponsors = () => (
    <table className="border-collapse">
        ...
        <tr className="h-56">
            ...
            <td className="border-2 border-gray-300 p-3">
                <a
                    href="https://posthog.com/?utm_source=github&utm_medium=sponsorship&utm_campaign=estore-frontend"
                    target="_blank"
                >
                    <Image
            ...
            <td className="border-2 border-gray-300 p-3">
                <a
                    href="https://betterstack.com/?utm_source=github&utm_medium=sponsorship&utm_campaign=estore-frontend"
                    target="_blank"
                >
                    <Image
        ...
        <tr className="h-56">
            <td className="border-2 border-gray-300 p-3">
                <a
                    href="https://www.checklyhq.com/?utm_source=github&utm_medium=sponsorship&utm_campaign=estore-frontend"
                    target="_blank"
                >
                    <Image
